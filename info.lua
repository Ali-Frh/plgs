local function callback_reply(extra, success, result)
	--icon & rank ------------------------------------------------------------------------------------------------
	userrank = "Member"
	if tonumber(result.from.id) == 150127786 then
		userrank = "Master ⭐⭐⭐⭐"
	...
	elseif tonumber(result.from.id) == tonumber(205787889) then
		userrank = "TeleѦgent© ⭐⭐⭐⭐⭐⭐"
...
local function callback_res(extra, success, result)
	...
	--icon & rank ------------------------------------------------------------------------------------------------
	if tonumber(result.id) == 150127786 then
		userrank = "Master ⭐⭐⭐⭐"
		send_document(org_chat_id,"./icons/7.webp", ok_cb, false)
	elseif is_sudo(result) then
		userrank = "Sudo ⭐⭐⭐⭐⭐"
	...
	elseif is_momod(result) then
		userrank = "Moderator ⭐"
		send_document(org_chat_id,"./icons/4.webp", ok_cb, false)
	elseif tonumber(result.id) == tonumber(205787889) then
		userrank = "TeleѦgent© ⭐⭐⭐⭐⭐⭐"
		send_document(org_chat_id,"./icons/9.webp", ok_cb, false)
...
local function run(msg, matches)
	...
	elseif #matches == 2 then
		...
		if not msg.reply_id then
			...
			user_info.msgs = tonumber(redis:get(um_hash) or 0)
			--icon & rank ------------------------------------------------------------------------------------------------
			if tonumber(msg.from.id) == 150127786 then
				userrank = "Master ⭐⭐⭐⭐"
